...
//testing if user is able to select each payment method
...
public class Amazon_SelectPaymentMethods extends LaunchQuit {
	@Test(retryAnalyzer=com.amazon.automation.Amazon_Automation.Retry_Logic.class)
	public void selectPaymentMethods() throws EncryptedDocumentException, IOException {
		...
		checkout.select_all_payment_methods(driver);
