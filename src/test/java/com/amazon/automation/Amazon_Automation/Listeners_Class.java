...
public class Listeners_Class implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		File destination = new File(
				"C:\\Users\\ashwathnpj\\javaprograms\\Amazon_Automation\\src\\screenshots\\pass\\Passed"+timestamp+ "_" + testName + ".png");
		try {
	...
	public void onTestFailure(ITestResult result) {
		...
		File destination = new File(
				"C:\\Users\\ashwathnpj\\javaprograms\\Amazon_Automation\\src\\screenshots\\fail\\Failed"+timestamp+ "_" + testName + ".png");
		try {
			FileHandler.copy(source, destination);
		} catch (IOException e) {
			// TODO Auto-generated catch block
